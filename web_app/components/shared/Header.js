          ...
          <div className="header-top-middle">
            <div className="header-store-logo-ctr">
              <a className="header-store-logo" href="http://www.americangolf.co.uk">
                ...
                </div><span className="storename">American
                  Golf</span></a>
            </div>
          </div>
          ...
          <div className="header-navigation-right">
            <div className="header-search-ctr header-search-ctr-desktop">
              <form role="search" action="/search-results" method="get" name="simpleSearch2" className="simplesearch-form suppress" id="simpleSearch2">
                <fieldset>
                  <label className="visually-hidden" htmlFor="q2">Search</label> <input type="text" id="q2" name="q" defaultValue className="input-search" placeholder="Search American Golf ..." data-searchsuggest="{&quot;suggestURL&quot;:&quot;/on/demandware.store/Sites-AmericanGolf-GB-Site/en_GB/Search-GetSuggestions&quot;,&quot;viewMoreURL&quot;:&quot;/search-results?q=xxx&quot;,&quot;viewMoreCaption&quot;:&quot;View more results&quot;}" autoComplete="off" /> <button className="button button-search submit" type="submit"><i className="icon icon-search">
                      {/* Icon */}</i></button>
                </fieldset>
              </form>
            </div>
